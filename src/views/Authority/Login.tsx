...
import { getTopPlaylist } from "@/service/api";

export default function Login() {
  const { data: TopPlaylist } = useRequest(() =>
    ...
    <div className="w-full  flex justify-center">
      ...
      <div className="w-[800px]  flex flex-col">
        <div className="title my-[40px] w-full flex justify-center items-center">
          <div className="logo  w-[45px] leading-[40px] h-[40px]">logo</div>
          ...
          <Card style={{ width: 800, height: 500 }}>
            <div className="flex">
              ...
              <div className="w-1/2 content p-[40px]">
                <div className="text-center text-[20px] font-normal w-full ">
                  账号密码登录
                </div>
                  ...
                  >
                    ...
                    >
                      <div className="w-full h-full flex items-center">
                        ...
                        <div className="h-full w-[45%]">455</div>
                      </div>
                    </Form.Item>
